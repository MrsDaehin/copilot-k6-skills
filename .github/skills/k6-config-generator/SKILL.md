...
- `examples/load.json`: Basic load test with ramping arrival rate.
- `examples/stress.json`: Stress test with gradual load increase.
- `examples/benchmark.json`: Benchmark test with constant arrival rate.
- `examples/endurance.json`: Endurance test for prolonged high load.