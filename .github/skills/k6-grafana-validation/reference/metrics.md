...
Companion to the `k6-grafana-validation` skill. For metrics streamed to Prometheus, see the metric mapping section in `SKILL.md`.
...
| `http_req_failed` | Rate | Rate of failed requests (non-2xx/3xx or unexpected status) |
